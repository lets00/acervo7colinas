            ...
            <Grid item xs={12} md={6}>
                <Grid container spacing={5} justifyContent="center">
                    ...
                    <Box className="card" sx={{mt:2}}>
                            ...
                            <Box component="img" src={RG} alt="RG" className="imgRG" sx={{width: '200px', height: '220', mt: 4}} />
                            <Button
            ...
            <Grid item xs={12} md={6}>
                <Grid container spacing={5} justifyContent="center">
                    <Box className="card" sx={{mt:2, width: '500px !important'}}>
                            ...
                            <Box component="img" src={ComprovanteRes} alt="Residência" className="img-comprovante" sx={{ width:"200px", height:"150px", mt:3}}/>
                            <Button
                                sx={{ color: "#242424", backgroundColor: "#ccd3f8 ", ml:5, mt:-5}}
                                component="label"
                                role={undefined}
