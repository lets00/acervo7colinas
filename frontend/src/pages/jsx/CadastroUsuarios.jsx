                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <Grid container spacing={2} justifyContent="center">
                            ...
                            <Grid container spacing={4}>
                                ...
                                <Grid item xs={6}>
                                    <TextField required fullWidth label="RG" size="small" sx={{ width: "460px" }}
                                        ...
                                        error={!!errors.rg} helperText={errors.rg || ''} />
                                </Grid>
                            </Grid>
                        </Grid>
                        ...
                        <Grid container spacing={4} justifyContent="center" sx={{ mb: 2 }}>
                            <FormControl sx={{ mt: -1, width: '460px', mr: 4 }} variant="outlined" error={!!errors.senha}>
                            ...
                            <FormControl sx={{ mt: -1, width: '460px' }} variant="outlined" error={!!errors.confirmarSenha}>
                    ...
                    <Grid container spacing={2} justifyContent="center">
                            ...
                            <Grid container spacing={4}>
                                <Grid item xs={6}>
                                    <TextField required fullWidth label="Rua" size="small" sx={{ width: "794px", mt: 2 }}
                                        ...
                                        error={!!errors.rua} helperText={errors.rua || ''} />
                                </Grid>
                                <Grid item xs={6}>
                            ...
                            <Grid container spacing={4}>
                                ...
                                <Grid item xs={6}>
                                    <TextField required fullWidth label="Bairro" size="small" sx={{ width: "460px", mt: 1 }}
                                        ...
                                        error={!!errors.bairro} helperText={errors.bairro || ''} />
                                </Grid>
                            </Grid>
                        </Grid>
                        ...
                        <Grid item xs={12} md={6}>
                            <Grid container spacing={4}>
                                <Grid item xs={6}>
                                    <FormControl required fullWidth size="small" sx={{ width: "460px", mt: 1 }} error={!!errors.cidade}>
                                ...
                                <Grid item xs={6}>
                                    <TextField required fullWidth label="Complemento" size="small" sx={{ width: "460px", mt: 1 }}
                                        ...
                                        error={!!errors.complemento} helperText={errors.complemento || ''} />
                                </Grid>
                            </Grid>
                        </Grid>
                    </Grid>
