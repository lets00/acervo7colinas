...
function CadastroLivros() {
  ...
  return (
    <Box sx={{ display: "flex", justifyContent: "center", alignItems: "center", p: 4, minHeight: "100vh", bgcolor: "#fff" }}>
      <Box sx={{ width: "100%", maxWidth: "800px" }}>
        
        
        <Typography variant="h4" align="center" sx={{ mb: 6, fontWeight: "500", color: "#333" }}>
          Cadastro Dos Livros!
        </Typography>
        ...
        <Box sx={{backgroundColor: "#CCD3F8",display: "flex", justifyContent: "flex-start", alignItems: "center", 
          ...
          <Typography sx={{ color: "#333", fontWeight: "500", fontSize: "1.1rem" }}>
            Cadastro Dos Livros:
          </Typography>
        </Box>
        ...
        <form onSubmit={cadastrolivro}>
          <Grid container spacing={4} justifyContent="center" >
            ...
            <Grid item xs={12} md={6}>
              <Box sx={{ display: "flex", flexDirection: "column", gap: 4}}>
                <TextField required fullWidth label="Título" variant="outlined" size="small"  sx={{ width: '280px' }}/>
                <TextField required fullWidth label="ISBN" variant="outlined" size="small" sx={{ width: '280px' }} />
            ...
            <Grid item xs={12} md={6}>
              <Box sx={{ display: "flex", flexDirection: "column", gap: 3 }}>
                <TextField required fullWidth label="Autor" variant="outlined" size="small" sx={{ width: '280px' }}/>
                <TextField required fullWidth label="Editora" variant="outlined" size="small" sx={{ width: '280px' }} />
                
                <TextField label="Descrição" multiline rows={8.5} fullWidth variant="outlined" helperText="0/100"/>
              </Box>
            </Grid>
          </Grid>
          <Box sx={{ mt: 5, display: "flex", gap: 2, justifyContent: "center" }}>
            <Button
              type="submit"
              variant="contained"
              sx={{ backgroundColor: "#283593", px: 5, py: 1, fontWeight: "bold",minWidth: "150px" 
              }}>
              CADASTRAR
            </Button>
            <Button 
